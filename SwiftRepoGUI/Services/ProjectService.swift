...
nonisolated public enum ProjectService {
    public static func validateProject(
        projectPath: String,
    ...
    public static func makeProjectInfo(
    ...
    public static func changedRepositories(
    ...
    public static func fetchRevisions(for candidates: [RepositoryCandidate]) async -> [SwiftRepository] {
        await withTaskGroup(of: SwiftRepository.self) { group in
    ...
    public static func listRepositoryCandidates(in root: URL) throws -> [RepositoryCandidate] {
        let children: [URL]
        do {
    ...
    public static func sortRepositories(_ repositories: [SwiftRepository]) -> [SwiftRepository] {
    ...
    public static func currentRevision(at repoPath: URL, timeout: TimeInterval = 2) async -> String? {
    ...
    public static func detectBuildSubdirs(in buildRoot: URL) throws -> [String] {
    ...
    public static func repoNinjaDirectoryName(_ repoName: String, platform: String, arch: String) -> String {
        switch repoName {

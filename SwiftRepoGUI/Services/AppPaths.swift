...
nonisolated public enum AppPathsError: Error, LocalizedError, Sendable {
...
nonisolated public enum AppPaths {
    public static let bundleID = "com.physicalsoftware.SwiftRepoGUI"
    ...
    public static func logFileURL(for operationID: UUID) throws -> URL {
        try logsDirectory().appendingPathComponent("\(operationID.uuidString).log")
    }

    public static func logFileURL(named fileName: String) throws -> URL {

...
public struct BuildOperationsMachine: StateMachine {
    public typealias Context = BuildOperationsContext
    public typealias StateID = BuildOpsState
    public typealias EventID = BuildOpsEvent
    
    public init() {}

    public var context: BuildOperationsContext { .init() }
...
public enum BuildProcessFailure: Error, CustomStringConvertible {
    case missingJob

...
public struct ProjectMachine: StateMachine {
    public typealias Context = ProjectContext
    public typealias StateID = ProjectState
    public typealias EventID = ProjectEvent
    
    public init() {}

    public var context: ProjectContext { .init() }
